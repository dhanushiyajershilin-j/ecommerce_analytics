...
tab1, tab2, tab3, tab4 = st.tabs(
    [" Trend Analysis", "Customer Segmentation", " Behavioral Analysis", " Business Insights"]
)
...
with tab4:
    st.subheader("Auto-Generated Business Insights & Recommendations")
...
st.caption("E-Commerce Analytics Flow — Data Collection → Cleaning → Feature Engineering → EDA → "
           "Segmentation → Behavioral Analysis → Trend Analysis → Business Insights → Dashboard")
